        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("Omaha Area Event", "Omaha Area Event"),
                            ("Place to Visit", "Place to Visit"),
                            ("Family Activity", "Family Activity"),
                            ("Great Place to Eat", "Great Place to Eat"),
                        ],
                        default="Omaha Area Event",
                        max_length=100,
                    ),
                ),
                ...
                (
                    "photo",
                    models.ImageField(blank=True, null=True, upload_to="happenings/"),
                ),
